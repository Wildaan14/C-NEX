...
export function HeroSection() {
  ...
  const popularServices = [
    {
      ...
      subtitle: t.service_carbon_tracking_desc,
      category: t.services,
      popular: true,
    },
    {
      ...
      subtitle: t.service_carbon_credit_desc,
      category: t.marketplace,
      popular: true,
    },
    {
      icon: Leaf,
      title: t.service_carbon_offset,
      subtitle: t.service_carbon_offset_desc,
      category: t.projects,
      popular: false,
    },
    {
      ...
      subtitle: t.service_carbon_report_desc,
      category: t.reports,
      popular: false,
    },
  ];
  ...
  const compactStats = [
    { number: "2.5M", label: "Ton CO₂ Offset", sublabel: "Total karbon" },
    { number: "450+", label: "Proyek Aktif", sublabel: "Di seluruh dunia" },
    { number: "24/7", label: "Real-time Data", sublabel: "Akses kapan saja" },
  ];

  const trustPoints = [
    {
      icon: Shield,
      label: t.trust_certified,
      desc: t.trust_certified_desc,
    },
    {
      icon: Clock,
      label: t.trust_transparent,
      desc: t.trust_transparent_desc,
    },
    {
      icon: Zap,
      label: t.trust_verified,
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center justify-center min-h-screen py-16 text-center">
          ...
          >
            <UnifiedCard
              hover={false}
              className="inline-block px-6 py-3 min-h-0"
            >
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 px-8 py-3.5 text-base font-semibold rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 group"
              >
            ...
            <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
              <Button
                variant="outline"
                size="lg"
                className="border-2 border-border hover:bg-secondary/50 px-8 py-3.5 text-base font-semibold rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300"
              >
