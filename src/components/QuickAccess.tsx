...
export function QuickAccess() {
  ...
  const services = [
    {
      icon: BarChart3,
      title: t.service_carbon_tracking,
      description: t.service_carbon_tracking_desc + ", Data Analytics",
      href: "#",
      color: "primary",
      popular: true,
    ...
    {
      icon: TrendingUp,
      title: t.service_carbon_credit,
      description: t.service_carbon_credit_desc + ", Carbon Market",
      href: "#",
      color: "emerald",
      popular: true,
    ...
    {
      icon: Leaf,
      title: t.service_carbon_offset,
      description: t.service_carbon_offset_desc + ", Tree Planting",
      href: "#",
      color: "primary",
      popular: true,
      estimatedTime: "1-7 hari",
      completedToday: 67,
    },
    {
      icon: FileCheck,
      title: t.service_carbon_report,
      description: t.service_carbon_report_desc + ", GHG Protocol",
      href: "#",
      color: "emerald",
      popular: false,
    ...
    {
      icon: Shield,
      title: t.service_carbon_audit,
      description: t.service_carbon_audit_desc + ", ISO 14064",
      href: "#",
      color: "primary",
      popular: false,
      estimatedTime: "14 hari",
      completedToday: 15,
    },
  ];
        ...
        >
          {services.map((service, index) => {
            ...
            return (
              ...
              >
                <Card
                  className={`relative p-6 lg:p-8 border-0 shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden bg-gradient-to-br from-card to-secondary/30`}
                >
                  {/* Popular Badge */}
                  {service.popular && (
                    <motion.div
                  ...
                  >
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${colors.gradient} opacity-0 group-hover:opacity-20 transition-opacity duration-300`}
                    />
                    <Icon
                      className={`w-8 h-8 ${colors.icon} relative z-10 group-hover:scale-110 transition-transform duration-300`}
                    />
                  </motion.div>
                    ...
                    <div className="space-y-3 mb-6">
                      ...
                      >
                        <div className="flex items-center gap-2 text-muted-foreground">
                          ...
                          <span>
                            {t.estimated_time} {service.estimatedTime}
                          </span>
                        </div>
                        <div className="flex items-center gap-2 text-primary">
                          <CheckCircle className="w-3 h-3" />
                          <span>
                            {service.completedToday} {t.completed_today}
                          </span>
                        </div>
                      </motion.div>
                    </div>
        ...
        >
          {[
            ...
            return (
              ...
              >
                <div
                  className={`w-12 h-12 bg-secondary/50 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:shadow-sm transition-shadow duration-300`}
                >
