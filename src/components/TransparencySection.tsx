...
export function TransparencySection() {
  ...
  const transparencyWidgets = [
    ...
    },
    {
      ...
      icon: MessageCircle,
      title: t.e_report,
      description: t.e_report_desc,
      value: 1247,
      displayValue: "1,247",
      subtitle: t.reports_received,
      progress: 89,
      link: "#",
      change: "+156",
      trend: "up",
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex gap-1">
                      <Button
                        size="sm"
                        variant="ghost"
                        className="p-2 hover:bg-primary/10 w-8 h-8"
                      >
        ...
        >
          <UnifiedCard hover={false} className="text-center min-h-0">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {[
                {
                  id: "budget-distributed",
                  title: t.budget_distributed,
                  value: "1.56T",
                  percentage: 65,
                },
                {
                ...
                >
                  <motion.div className="text-xl font-bold text-foreground mb-1">
                    <AnimatedCounter
                      end={parseFloat(item.value.replace(/[^0-9.]/g, ""))}
                      suffix={item.value.includes("T") ? "T" : ""}
                    />
                  </motion.div>
