...
export function Footer() {
  ...
  const transparencyLinks = {
    id: ["Laporan Keuangan", "APBD 2025", "Data Terbuka", "e-LAPOR"],
    en: ["Financial Report", "Regional Budget 2025", "Open Data", "e-Report"],
  };
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start gap-2">
                ...
                <div className="text-muted-foreground">
                  <p>Balai Kota Medan</p>
                  <p>Jl. Balai Kota No.1, Kesawan</p>
                  <p>Medan Barat, Kota Medan</p>
                  <p>Sumatera Utara 20111</p>
                </div>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-muted-foreground" />
                <span className="text-muted-foreground">(061) 4515000</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-muted-foreground" />
                <span className="text-muted-foreground">
                  info@pemkotmedan.go.id
                </span>
              </div>
              <div className="flex items-center gap-2">
                <Globe className="w-4 h-4 text-muted-foreground" />
                <span className="text-muted-foreground">
                  www.pemkotmedan.go.id
                </span>
              </div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <Button
                size="sm"
                variant="ghost"
                className="w-8 h-8 p-0 text-muted-foreground hover:bg-primary hover:text-primary-foreground"
              >
